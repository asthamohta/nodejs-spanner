...
async function test(instanceId, databaseId, projectId) {
  ...
  try {
    ...
    rows.forEach(row => {
      ...
      console.log(`SingerId: ${json.SingerId}, Revenue: ${json.FirstName}`);
    });
  } catch (err) {
...
await test('astha-testing', 'abcd', 'span-cloud-testing');
